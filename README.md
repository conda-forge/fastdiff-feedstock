...
Once the `conda-forge` channel has been enabled, `fastdiff` can be installed with:

```
conda install fastdiff
```

It is possible to list all of the versions of `fastdiff` available on your platform with:
